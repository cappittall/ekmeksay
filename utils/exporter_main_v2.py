...
flags.DEFINE_string('pipeline_config_path', './checkpoint/ssd_resnet50_v1_fpn_640x640_coco17_tpu-8.config',
                    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
                    'file.')
flags.DEFINE_string('trained_checkpoint_dir', './checkpoint',
